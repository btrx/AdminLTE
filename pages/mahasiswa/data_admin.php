...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      DATA ADMIN
        ...
        <ol class="breadcrumb">
            <li><a href="data_admin.php"><i class="fa fa-dashboard"></i> HOME</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <a href="data_admin.php?page=tambah_mahasiswa" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
                    </div>
